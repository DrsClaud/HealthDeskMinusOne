 ...
 */
/**
 * Cloud smoke test for the deployed `callLLMAPI` Firebase function.
 *
 * Skipped automatically when credentials are not configured.
 * Run with: npm run test:all -- --testPathPattern=callLLMAPI.cloud
 *
...
describeIfConfigured("callLLMAPI (cloud smoke)", () => {
